package Leccion2.ManejoVariables;
...
public class ManejoVariablesTest {
    ...
    public static void main(String[] args) {
        ...
        char ch1 = 65, ch2 = 'A'; //Usar comillas simples
        ...
        int hexa = 0x64; //Valor Hexadecunak ubucua cib 0x
        System.out.println("Valor int decimal: " + decimal);
        System.out.println("Valor int octal: " + octal);
        System.out.println("Valor int hexadecilam: " + hexa);
        System.out.println("");
